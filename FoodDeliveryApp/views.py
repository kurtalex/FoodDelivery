...
from FoodDeliveryApp.forms import UserForm, RestaurantForm, UserFormForEdit, MealForm
from FoodDeliveryApp.models import Meal, Order, OrderDetails, Driver
...
def restaurant_report(request):
    ...
    # Top 3 Meals
    top_meals = Meal.objects.filter(restaurant=request.user.restaurant).annotate(
